...
export const env = createEnv({
  ...
  server: {
    ...
    POSTGRES_URL_NON_POOLING: defaultUnlessDeployed(
      z.string().url(),
      // Typically the same as DATABASE_URL for local development or when not using a separate pooling connection.
      // Used for Supabase direct connections, e.g., for running migrations.
      "postgresql://postgres:postgres@127.0.0.1:54322/postgres",
    ),
